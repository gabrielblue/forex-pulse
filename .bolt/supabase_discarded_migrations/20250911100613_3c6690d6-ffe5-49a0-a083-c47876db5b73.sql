...
DROP POLICY IF EXISTS "Authenticated users can view their own live trades" ON public.live_trades;
DROP POLICY IF EXISTS "Authenticated users can create their own live trades" ON public.live_trades;
DROP POLICY IF EXISTS "Authenticated users can update their own live trades" ON public.live_trades;
DROP POLICY IF EXISTS "Authenticated users can delete their own live trades" ON public.live_trades;
...
DROP POLICY IF EXISTS "Authenticated users can view their own portfolio" ON public.user_portfolios;
DROP POLICY IF EXISTS "Authenticated users can insert their own portfolio" ON public.user_portfolios;
DROP POLICY IF EXISTS "Authenticated users can update their own portfolio" ON public.user_portfolios;
DROP POLICY IF EXISTS "Authenticated users can delete their own portfolio" ON public.user_portfolios;
...
DROP POLICY IF EXISTS "Authenticated users can view their own bot settings" ON public.bot_settings;
DROP POLICY IF EXISTS "Authenticated users can insert their own bot settings" ON public.bot_settings;
DROP POLICY IF EXISTS "Authenticated users can update their own bot settings" ON public.bot_settings;
DROP POLICY IF EXISTS "Authenticated users can delete their own bot settings" ON public.bot_settings;
...
-- Create indexes for better performance on user_id lookups (if not exists)
